...
namespace SnakeGame
{
    public partial class frmSnake : Form
    {
        ...
        GameBoardFields[,] gameBoardField;//gameboardfields type array for all the fields inside gameboardfields which is called gameboardfield
        SnakeCoordinates[] snakeXY; //array of snakecoordinates called snakexy
        int snakeLength;
        Directions direction; //directions type variable for direction called direction
        Graphics g;
        ...
        {
            picGameBoard.Image = new Bitmap(640, 640);
